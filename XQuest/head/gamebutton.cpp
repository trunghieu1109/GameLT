...
GameButton::GameButton(int posX, int posY, const string &title, TTF_Font *font,const string &next, SDL_Renderer* renderer, int type)
{
...
GameButton::GameButton(int posX, int posY, const string &title, const string &path, TTF_Font *font,const string &next, SDL_Renderer* renderer, int type)
{
    buttonPosition.x = posX;
    buttonPosition.y = posY;
    mType = type;
...
string GameButton::EventHandle(SDL_Event *e)
{
